...
urlpatterns = [
    ...
    path('garages/<uuid:pk>/members/', views.garage_members, name='shop-garage-members'),
    path('garages/<uuid:pk>/members/<int:membership_pk>/role/', views.garage_member_role, name='shop-garage-member-role'),
